...
After [APT setup](https://github.com/shreyam1008/dbterm/blob/main/docs/apt-signing.md), run `sudo apt install dbterm`. Snap is a
GitHub candidate; Snap Store and Flatpak are not published. Microsoft Store's
...
[![License: MIT](https://img.shields.io/badge/License-MIT-success.svg)](https://github.com/shreyam1008/dbterm/blob/main/LICENSE)
...
See the [complete feature map](https://dbterm.shreyam1008.com.np/features/) or jump to the [Backup Center handbook](https://dbterm.shreyam1008.com.np/backup.md).
...
- Distribution, submission, and promotion record: [docs/distribution-log.md](https://github.com/shreyam1008/dbterm/blob/main/docs/distribution-log.md)
- Product-domain and release contract: [docs/domain-release.md](https://github.com/shreyam1008/dbterm/blob/main/docs/domain-release.md)
...
See [docs/project-reference.md](https://github.com/shreyam1008/dbterm/blob/main/docs/project-reference.md#file-map) for the module-by-module map.
