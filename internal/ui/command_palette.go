...
var commandPaletteActionSpecs = []commandPaletteActionSpec{
	...
	{actionBackupCenter, "Open Backup Center", "Create schedules, run or prune backups, manage independent local/SFTP/rclone-pull copies, restore artifacts, and manage the agent. N creates a plan; C opens Copies.", "new saved database connection scheduled automatic copy push pull sftp rclone restore agent history retention encryption zstd zip", ""},
