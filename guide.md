...
This manual targets dbterm **v0.11.2 “Ganga”**. Backup Center adds focused creation forms, desktop folder browsing, searchable combined activity, filterable agent logs with follow, and configurable transient generation retries. The detailed recovery overview, independent verified copies and guarded restore remain available. Windows backup-agent registration uses a correctly encoded task definition.
